> **🗄️ ARCHIVADO (2026-07-11 · refactor documental, D40).** Versión íntegra de `PROMPTS.md` con los prompts de fases ya ejecutadas (#5 prototipo · #6 Etapa 2 · #7 Etapa 3 · #8 Fase 4 · #9 MVP-first · #10 conexión frontend↔backend, todos ✅ cerrados). El `PROMPTS.md` activo conserva solo los prompts operativos vivos.
