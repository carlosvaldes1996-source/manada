> **🗄️ ARCHIVADO (2026-07-11 · refactor documental, D40).** Plan original del sistema de componentes (2026-06-27, D12) + bitácora de ejecución por etapa (D13–D16). Se archiva íntegro: las §§1–8 eran el plan pre-implementación (superado en 3 puntos por D13) y la §9 una bitácora cuyo detalle canónico vive en `DECISIONS.md`. La arquitectura REAL del frontend vive en el `FRONTEND_ARCHITECTURE.md` activo.
