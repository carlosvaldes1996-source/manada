...
| U066 | **Redondeo de precios de suscripción** ($46.741 con decimales raros genera fricción en CLP). Definir política de redondeo. | 3 | 1 | **P2** | Pendiente · Polish (3.4): definir política de redondeo CLP de precios de suscripción | `lib/format.ts`, `lib/demo-data.ts` |
